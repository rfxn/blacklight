#!/usr/bin/env bash
#
# tools/synth-corpus.sh — orchestrator that emits a fleet-scale APSB25-94
...
#
# Usage:
#   tools/synth-corpus.sh [--seed N] [--out DIR]
#
# Defaults:
#   --seed 42
...
SYNTH="$REPO_ROOT/scripts/synthesize-fixture-logs.sh"
